...
import {editSubscription} from "../../store/actions/subscriptionsAction";
...
const EditSubscription = (props) => {
    ...
    const prepareFormOption = {
        ...
        initialValues: {end_date: subscription.end_date, id: subscription.id, subscription: subscription},
    };
    return <Modal {...props} content={<SubscriptionForm {...prepareFormOption} />}/>
};
