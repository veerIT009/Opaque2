...
const QuotationForm = (props) => {
    ...
    useEffect(() => {
        if (singleQuotation) {
            setSaleValue({
                date: singleQuotation
                    ? moment(singleQuotation.date).toDate()
                    : "",
                customer_id: singleQuotation ? singleQuotation.customer_id : "",
                warehouse_id: singleQuotation
                    ? singleQuotation.warehouse_id
                    : "",
                ...
                tax_amount: singleQuotation
                    ...
                    : "0.00",
                discount: singleQuotation
                    ? singleQuotation.discount.toFixed(2)
                    : "0.00",
                shipping: singleQuotation
                    ? singleQuotation.shipping.toFixed(2)
                    : "0.00",
                grand_total: singleQuotation
                    ? singleQuotation.grand_total
                    : "0.00",
