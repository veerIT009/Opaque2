...
import { fetchTestimonials } from "../../admin/store/actions/testimonialAction";
...
const Testimonials = (props) => {
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <TabTitle title={placeholderText("testimonials.title")} />
            <Row className="animated fadeIn">
                <Col sm={12} className="mb-2">
                    {/* <HeaderTitle title="Testimonials" />
                    <ProgressBar />
                    <h5 className="page-heading">
                        {getFormattedMessage("testimonials.title")}
                    </h5> */}
...
export default connect(mapStateToProps, { fetchTestimonials, toggleModal })(
    Testimonials
);
