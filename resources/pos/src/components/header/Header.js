            ...
            <div className="d-flex align-items-stretch justify-content-center">
                <Nav className="align-items-stretch justify-content-between flex-row">
                    ...
                    <Dropdown className="d-flex align-items-stretch me-3">
                        ...
                        <Dropdown.Menu>
                            <div className="menu-icon-grid d-flex justify-content-around  align-items-center flex-wrap p-2 pb-0">
                                <div className="d-sm-flex">
                                    <Dropdown.Item className="p-0 bg-white">
                                        <button
                                            className={`language-btn btn mb-2 mx-1 ${
                                                activeLanguage === "en"
...
export default connect(mapStateToProps, { logoutAction, updateLanguage })(
    Header
);
