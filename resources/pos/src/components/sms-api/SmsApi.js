...
import {
    fetchSmsApiSetting,
    updateSmsApiSetting,
} from "../../store/action/SmsApiAction";
...
const SmsApi = (props) => {
    ...
    const onSubmit = (event) => {
        ...
        const isValid =
            smsValue.length && smsValue.filter((sms) => sms.value === "");
        if (!isValid.length) {
                ...
                <div className="card-body">
                    <div className="col-sm-12 sms_api mb-10">
                        <div className="rounded-10 sms-api-main">
                            ...
                            <h5>
                                You can use any SMS APIs here, all you need to
                                set up is :
                            </h5>
                            <ul>
                                <li>URL - (URL of the SMS API)</li>
                                <li>
                                    Mobile Key - (Which will be the mobile key,
                                    each SMS provider have a different one, some
                                    have "to", some have "mobile", etc)
                                </li>
                                <li>
                                    Message Key - (Which will be the text
                                    message key, each SMS provide have a
                                    different one, "text" or "message", etc)
                                </li>
                                <li>
                                    Payload - which will be a JSON object, where
                                    you can enter any params according to the
                            ...
                            <ol className="mb-0">
                                <li>
                                    URL:
                                    https://www.example.com/api/send-message{" "}
                                </li>
                                <li>Mobile Key: "to"</li>
