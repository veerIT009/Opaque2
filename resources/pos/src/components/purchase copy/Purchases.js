...
const Product = (props) => {
    ...
    useEffect(() => {
        ...
        if (purchases.length) {
            ...
            // console.log({ newItemValue, latestArray, itemsValue });
        }
    }, [purchases.length]);
