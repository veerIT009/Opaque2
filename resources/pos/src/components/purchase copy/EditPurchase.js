...
const EditPurchase = (props) => {
    ...
    const selectedStatus =
        ...
        purchases.attributes.status &&
        status.filter((item) => item.value === purchases.attributes.status);
    const supplierId =
        purchases && purchases.attributes && purchases.attributes.supplier_id;
    const warehouseId =
        purchases && purchases.attributes && purchases.attributes.warehouse_id;
    const supplier =
    ...
    const purchasesItemsId =
        purchases &&
        purchases.attributes &&
        purchases.attributes.purchase_items &&
        purchases.attributes.purchase_items.map((item) => item.id);

    const itemsValue = purchases &&
        purchases.attributes && {
            ...
            purchase_items: editPrepareArray(
                purchases.attributes.purchase_items,
                purchases.attributes.warehouse_id
            ),
            newItem: "",
