...
import { fetchMemberBooksHistory } from "../../admin/store/actions/memberBookHistoryAction";
...
const MemberBookHistory = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) =>
                (row.book_code =
                    row.book_item.edition + ` (${row.book_item.book_code})`),
        },
        {
...
export default connect(mapStateToProps, { fetchMemberBooksHistory })(
    MemberBookHistory
);
