...
const EmailTemplates = (props) => {
    ...
    const goToEditProduct = (item) => {
        const id = item.id;
        navigate(`/admin/pos/email-templates/${id}`);
    };
    ...
    const itemsValue =
        ...
        emailTemplates.map((emailTemplate) => ({
            ...
            is_active:
                emailTemplate?.attributes?.status === 0 ||
                emailTemplate?.attributes?.status === false
                    ? false
                    : true,
            id: emailTemplate.id,
        }));
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable
                ...
                to="#/admin/pos/email-templates/create"
            />
        </MasterLayout>
    );
};
