                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='py-4'>
                                                <div>
                                                    ...
                                                    {alert.product_unit === '1' && <span className='badge bg-light-success me-2'><span>{getFormattedMessage("unit.filter.piece.label")}</span></span>
                                                    || alert.product_unit === '2' && <span className='badge bg-light-primary me-2'><span>{getFormattedMessage("unit.filter.meter.label")}</span></span>
                                                    || alert.product_unit === '3' && <span className='badge bg-light-warning me-2'><span>{getFormattedMessage("unit.filter.kilogram.label")}</span></span>}
                                                </div>
                                            </td>
