            ...
            <Col className="col-12 mb-4">
                <Row>
                    {/* <Widget
                        ...
                        onClick={() =>
                            onClick("admin/pos/sales", "manage_sale")
                        }
                    ...
                    <Widget
                        ...
                        allConfigData={allConfigData}
                        onClick={() =>
                            onClick("admin/pos/purchases", "manage_purchase")
                        }
                    ...
                    <Widget
                        ...
                        allConfigData={allConfigData}
                        onClick={() =>
                            onClick("admin/pos/expenses", "manage_expenses")
                        }
                        className={`bg-info ${
                            config &&
                            config.filter((item) => item === "manage_expenses")
                                .length !== 0
                                ? "cursor-pointer"
                                : ""
                        }`}
                        ...
                        value={
                            allSalePurchase.all_expense_count
                                ? parseFloat(
                                      allSalePurchase.all_expense_count
                                  ).toFixed(2)
                                : "0.00"
