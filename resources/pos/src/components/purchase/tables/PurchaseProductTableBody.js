...
import ProductModal from "./PurchaseProductModal";
...
import { deleteQuotationToPurchaseItems } from "../../../store/action/quotationToPurchaseAction";

const PurchaseProductTableBody = (props) => {
    const {
        deleteQuotationToPurchaseItems,
        singleProduct,
        index,
        updateProducts,
        setUpdateProducts,
    ...
    useEffect(() => {
        singleProduct.sub_total = Number(
    ...
    const onDeleteCartItem = (id) => {
        ...
        deleteQuotationToPurchaseItems(id);
    };
