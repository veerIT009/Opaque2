...
const LetterProductModal = (props) => {
    const {
        product,
        setIsShowModal,
        isShowModal,
    ...
    const [netUnit, setNetUnit] = useState(product.price);
    ...
    //     product.discount_type === "1" || product.discount_type === 1
    //         ? {
    ...
    useEffect(() => {
        ...
        //     netUnit
        //         ? netUnit.toFixed(2)
        //         : parseFloat(product.fix_net_unit.toFixed(2))
        // );
        // setTaxValue(
        //     product.tax_value
    ...
    const handleValidation = () => {
        ...
        let isValid = false;
        // if (taxValue > 100) {
        //     errorss["taxValue"] = getFormattedMessage(
        //         "globally.tax-length.validate.label"
        //     );
        // } else if (discountType.value === 1 && Number(discountValue) > 100) {
        //     errorss["discountValue"] = getFormattedMessage(
        //         "globally.discount-length.validate.label"
        //     );
        // } else if (
        //     discountType.value === 2 &&
        //     Number(discountValue) >= netUnit
        // ) {
        //     errorss["discountValue"] = getFormattedMessage(
        //         "globally.discount-price-length.validate.label"
        //     );
        // } else if (netUnit === null) {
        //     errorss["netUnit"] = getFormattedMessage(
    ...
    const onSaveDetailModal = (e) => {
        ...
        if (valid) {
            ...
            newProduct.price = Number(netUnit);
            ...
            // if (productUnit) {
            //     newProduct.sale_unit = productUnit.value
            //         ? productUnit.value
            //         : productUnit;
            // }
            ...
            //         : productUnit)
            // );
            updateSubTotal(product.quantity * product.price);
        }
    };
                    ...
                    <Row>
                        <div className="col-md-12 mb-5">
                            ...
                            <span className="text-danger d-block fw-400 fs-small mt-2">
                                {errors["netUnit"] ? errors["netUnit"] : null}
                            </span>
                        </div>
                        {/* <div className="col-md-12 mb-5">
                            {defaultTaxType && (
                        ...
                        {/* <div className="col-md-12 mb-5">
                            ...
                            <span className="text-danger d-block fw-400 fs-small mt-2">
                                {errors["taxValue"] ? errors["taxValue"] : null}
                            </span>
                        </div> */}
                        {/* <div className="col-md-12 mb-5">
                            <ReactSelect
...
export default LetterProductModal;
