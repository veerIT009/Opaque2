...
import { deleteQuotation } from "../../store/action/sanctionQuotationAction ";

const DeleteQuotation = (props) => {
    const { onDelete, deleteModel, onClickDeleteModel, deleteQuotation } =
        props;
        ...
        <div>
            {deleteModel && (
                <DeleteModel
                    ...
                    name={getFormattedMessage("quotation.title")}
                />
            )}
        </div>
    );
