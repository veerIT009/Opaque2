...
const ExpenseForm = (props) => {
    ...
    const [expenseValue, setExpenseValue] = useState({
        ...
        // purchase_id: singleExpense ? singleExpense[0].purchase_id : "",
    ...
    // const [selectedPurchaseOrder] = useState(
    //     singleExpense
    //         ? [
    //               {
    //                   label: singleExpense[0].purchase_id[0].label,
    //                   value: singleExpense[0].purchase_id[0].value,
    //                   grand_total: singleExpense[0].purchase_id[0].grand_total,
    //               },
    //           ]
    //         : null
    // );
    ...
    const handleValidation = () => {
        ...
        // else if (!expenseValue["purchase_id"]) {
        //     errorss["purchase_id"] = "Please Select Purchase Order";
        // }
    ...
    const prepareData = (prepareData) => {
        const formValue = {
            ...
            // purchase_id: prepareData.purchase_id.value,
                    ...
                    <div className="row">
                        ...
                        {/* <div className="col-md-6 mb-3">
                            <ReactSelect
                                ...
                                errors={errors["purchase_id"]}
                                data={quotationPurchase}
