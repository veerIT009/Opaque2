...
const CustomerReportDetails = (props) => {
    ...
    const { frontSetting, customerReportWidgetData, allConfigData } =
    ...
    return (
        <MasterLayout>
            <TopProgressBar />
            <HeaderTitle
                title={getFormattedMessage("customer.report.details.title")}
                to="/admin/pos/report/customers"
            />
            <TabTitle
                title={placeholderText("customer.report.details.title")}
            />
            <Row className="g-4 justify-content-center">
                <Widget
                    ...
                    currency={""}
                    value={
                        customerReportWidgetData?.totalSale
                            ? parseFloat(
                                  customerReportWidgetData?.totalSale
                              ).toFixed(2)
                            : "0.00"
                ...
                />
                <Widget
                    title={getFormattedMessage("pos-total-amount.title")}
                    className="bg-info"
                    ...
                    value={
                        customerReportWidgetData?.totalAmount
                            ? parseFloat(
                                  customerReportWidgetData?.totalAmount
                              ).toFixed(2)
                            : "0.00"
                ...
                />
                <Widget
                    title={getFormattedMessage("sale-paid.total.amount.title")}
                    ...
                    currency={currencySymbol}
                    value={
                        customerReportWidgetData?.totalPaid
                            ? parseFloat(
                                  customerReportWidgetData?.totalPaid
                              ).toFixed(2)
                            : "0.00"
                ...
                />
                <Widget
                    title={getFormattedMessage("sale-Due.total.amount.title")}
                    className="bg-info"
                    iconClass="bg-blue-300"
                    allConfigData={allConfigData}
                    icon={
                    ...
                    currency={currencySymbol}
                    value={
                        customerReportWidgetData?.totalSalesDue
                            ? parseFloat(
                                  customerReportWidgetData?.totalSalesDue
                              ).toFixed(2)
                            : "0.00"
            ...
            >
                ...
                <Tab
                    ...
                    title={getFormattedMessage("sale.payment.report.title")}
                    tabClassName="position-relative mb-3 me-7"
                >
                    <div className="w-100 mx-auto">
                        {key === "Sale-payment" && (
