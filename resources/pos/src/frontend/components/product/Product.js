                        ...
                        <Card.Body className='px-2 pt-2 pb-1 custom-card-body'>
                            ...
                            <p className='m-0 item-badges'>
                                <Badge bg='info' text='white' className='product-custom-card__card-badge'>
                                    {product.attributes.stock && product.attributes.stock.quantity} {product.attributes.product_unit === "1" && 'Pc' || product.attributes.product_unit === "2" && 'M' || product.attributes.product_unit === "3" && 'Kg'}
                                </Badge>
                            </p>
