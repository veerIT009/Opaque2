...
import {currencySymbolHendling, decimalValidate, getFormattedMessage, placeholderText} from '../../../shared/sharedMethod';

const CartItemMainCalculation = (props) => {
    const {totalQty, subTotal, cartItemValue, onChangeCart, grandTotal, frontSetting, allConfigData} = props;
