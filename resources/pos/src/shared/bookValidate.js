...
export default (formValues) => {
    ...
    if (!formValues.authors || !formValues.authors.length) {
        errors.authors = getFormattedMessage(
            "books.input.authors.validate.label"
        );
    }
    if (!formValues.name) {
    ...
    if (!formValues.genres || !formValues.genres.length) {
        errors.genres = getFormattedMessage(
            "books.input.genres.validate.label"
        );
    }
