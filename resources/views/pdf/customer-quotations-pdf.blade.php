...
<table width="100%">
    <tr>
        <td align="" style="vertical-align: bottom">
            <h2 style="color: dodgerblue;">{{ __('messages.pdf.quotation_list') }}</h2>
        </td>
    </tr>
</table>
<table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
    ...
    <tr style="background-color: dodgerblue;">
        ...
        <th style="color: #fff;">{{ __('messages.pdf.status') }}</th>
    </tr>
    </thead>
    ...
    @if(isset($customer->quotations))
        @foreach($customer->quotations  as $quotation)
            <tr align="center" style="border-bottom: 2px solid darkgrey;!important;">
                ...
                <td align="right">{{currencyAlignment(number_format((float)$quotation->grand_total))}}</td>
                <td>
