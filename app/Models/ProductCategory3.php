 ...
 * @mixin \Eloquent
 */
class ProductCategory3 extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    {
        /** @var Media $media */
        $media = $this->getMedia(ProductCategory3::PATH)->first();
        if (!empty($media)) {
    ...
    {
        return $this->hasMany(Product3::class, 'product_category_id', 'id');
    }
}
