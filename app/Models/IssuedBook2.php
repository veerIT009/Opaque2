 ...
 */
class IssuedBook2 extends Model
{
    use HasFactory;
    use SoftDeletes;
    ...
    {
        return $this->belongsTo(BookItem2::class, 'book_item_id');
    }
    ...
    {
        return $this->belongsTo(User2::class, 'issuer_id');
    }
    ...
    {
        return $this->belongsTo(User2::class, 'returner_id');
    }
