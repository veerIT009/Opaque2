...
class PurchaseReturnAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $purchasesReturn = $this->purchaseReturnRepository->all(
            $input,
            $request->get('skip'),
            $request->get('limit')
        );
        ...
        // $purchasesReturn = new PurchaseReturn();
        ...
        // $purchasesReturn = $purchasesReturn->where('reference_code', 'LIKE', "%$search%")->paginate($perPage);
    ...
    public function getPurchaseReturnProductReport(Request $request): PurchaseReturnCollection
    {
        ...
        $purchaseReturn = PurchaseReturn::whereHas(
            'purchaseReturnItems',
